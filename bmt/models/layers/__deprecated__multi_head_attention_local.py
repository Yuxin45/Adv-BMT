...
class MultiheadAttentionLocal(nn.Module):
    r"""Allows the layers to jointly attend to information
    ...
    Args:
        embed_dim: total dimension of the layers.
    ...
    """
    def __init__(self, embed_dim, num_heads, dropout=0.0, without_weight=False, vdim=None):
    ...
    def forward(
        ...
        **kwargs
        ...
        attn_output_weights = attention_utils_v2.attention_weight_computation(
        ...
        attn_output_weights = attn_output_weights.to(q)
        ...
        if ctx_rpe_value is not None:
            ...
            attn_output = infgen.models.ops.attention.attention_utils_v2.attention_value_computation(
